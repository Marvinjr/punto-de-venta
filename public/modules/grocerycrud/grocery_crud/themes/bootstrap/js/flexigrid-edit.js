$(function(){
	...
	$('#crudForm').submit(function(){
		...
		var form_data 			=	{ ...tendoo.csrf_data };
		$( this ).find( '[id^="field-"]' ).each( function(){
			form_data[ $( this ).attr( 'name' ) ] 	=	$( this ).val() === null ? [''] : $( this ).val();
			// console.log( $( this ).attr( 'name' ), $( this ).val(), { ...form_data } );
		});
		...
		$.ajax({
			...
			success: function(data){
				...
				$( '.chosen-container-multi' ).each( function(){
					...
					$( this ).find( '.chosen-choices [data-option-array-index]' ).each( function(){
