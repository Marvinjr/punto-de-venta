...
$StoreRoutes->get( '/nexo/reports/product-taxes', 'NexoPremiumController@dailyProductTaxReport' );
...
$StoreRoutes->get( '/nexo/reports/today-report', 'NexoPremiumController@todayReport' );
