    ...
    public function sessions()
    {
        ...
        for( $i = 0; $i < $dayDiff; $i++ ) {
            ...
            if ( $registerActivities ) {
                ...
                foreach( $registerActivities as $index => $activity ) {
                    if ( $activity[ 'TYPE' ] === 'opening' ) {
                        ...
                        $lastIdleIndex  =   null;
                    } else if ( $activity[ 'TYPE' ] === 'cashing' ) {
                        $cashing    +=  floatval( $activity[ 'BALANCE' ] );
                    } else if ( $activity[ 'TYPE' ] === 'disbursement' ) {
                        $disbursement    +=  floatval( $activity[ 'BALANCE' ] );
                    }
                }
            ...
            $results[]      =   [
                ...
                'expected_balance'  =>  $expectedBalance - $disbursement,
