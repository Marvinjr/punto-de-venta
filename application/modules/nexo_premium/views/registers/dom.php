...
<div id="registers-sessions">
    <div class="row">
            ...
            <div class="form-group">
                <div class="input-group date">
                    ...
                    <select v-model="cashier" class="form-control date-control pull-right">
                        <?php foreach( $this->events->apply_filters( 'np_registers_history_users', $users ) as $user ):?>
        ...
        <div class="col-md-12">
            ...
            <div class="row" id="stock-tracking">
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo __( 'Encaissement', 'nexo_premium' );?></td>
                                        <td class="text-right">{{ card.cashing | currency }}</td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __( 'Décaissement', 'nexo_premium' );?></td>
                                        <td class="text-right">{{ card.disbursement | currency }}</td>
                                    </tr>
                                    <tr class="success">
