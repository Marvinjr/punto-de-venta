...
tendooApp.controller( 'advancedSalesReportController', [ '$scope', '$http', function( $scope, $http ) {
    ...
    $scope.url                  =   {
        fetchURL                :   '<?php echo site_url( array( 'rest', 'nexo', 'sales_detailed' ) );?>' + '?<?php echo store_get_param( null );?>'
    }
    ...
    **/
    ...
    <?php $this->events->do_action( 'hook_into_detailed_sales_js' );?>
}]);
