...
<?php $this->events->do_action( 'hook_into_best_sales_dom' );?>
...
var Nexo_Best_Of		=	new function(){
	this.fetch_report	=	function( url, output_wrapper, filtre ) {
		...
		const newUrl		=	NexoAPI.events.applyFilters( 'nexopos_best_sales_chart_url', this.last_url + '<?php echo store_get_param( '?' );?>' + disable_cache );
