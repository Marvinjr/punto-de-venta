...
<?php $this->events->do_action( 'hook_into_customers_statistics_dom' );?>
...
var NexoCashierPerformance	=	new function(){
	...
	**/
	...
	this.GetStats			=	function( customer_id, start_date, end_date ){
		...
		const fetchURL 	=	NexoAPI.events.applyFilters( 'customers_statistics_url', '<?php echo site_url(array( 'nexo', 'customer_statistics' ));?>/' + start_date + '/' + end_date + '<?php echo store_get_param( '?' );?>' )
		$.ajax( fetchURL, {
