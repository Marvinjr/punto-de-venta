...
<div ng-controller="advancedSalesReportController">
    ...
    <div class="row report-wrapper">
        <div class="col-lg-6">
            <h4 class="visible-print text-center" ng-if="reportType === 'full'">
                <?php _e( 'Rapport des ventes détaillées', 'nexo_premium' );?>
            </h4>
            <h4 class="visible-print text-center" ng-if="reportType === 'small'">
                <?php _e( 'Rapport des ventes condensées', 'nexo_premium' );?>
            </h4>
            ...
            <?php $this->events->do_action( 'hook_into_detailed_sales_dom' );?>
        </div>
    </div>
</div>
