                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <td><?php echo __( 'Bénéfice', 'nexo_premium' );?></td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="category in categories">
                                ...
                                <td>{{ sumOutingValues( category ) - sumEntriesValue( category ) | currency }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<?php $this->events->do_action( 'hook_into_stock_tracking_dom' );?>
...
const StockTracking    =   new Vue({
    ...
    methods: {
        ...
        loadCategories() {
            ...
            const url   =   NexoAPI.events.applyFilters( 'stock_tracking_categories_url', 'api/nexopos/categories<?php echo store_get_param('?');?>' )
        ...
        generateReport() {
            this.isLoading      =   true;
            const url           =   NexoAPI.events.applyFilters( 'stock_tracking_report_url', 'api/nexopos/raw_stock_tracking<?php echo store_get_param('?');?>' );
