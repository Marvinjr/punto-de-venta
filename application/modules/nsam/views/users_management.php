...
$Users      =   $this->auth->list_users( 
    $this->events->apply_filters( 
        'nsam_users_management_roles', 
        [ 'store.cashier', 'store.manager', 'gastro.waiter', 'gastro.chief', 'store.demo', 'administrator', 'user' ]
    ) 
);
...
foreach( $Users as $User ) {
    ...
    $this->Gui->add_meta( array(
        'col_id'    =>  $col_id,
        'namespace' =>  'nsam_users_control_' . $User->user_id,
    ...
    foreach( $Stores as $store ) {
        ...
        ], 'nsam_users_control_' . $User->user_id, $col_id );
    }
