...
$Routes->get( 'nexo/customers/account/{id}/new', 'NexoCustomersController@accountNew' );
$Routes->get( 'nexo/customers/account/{id}/history', 'NexoCustomersController@accountHistory' );
$Routes->get( 'nexo/customers/reset-coupon-count/{id}', 'NexoCustomersController@resetCounter' );
$Routes->get( 'nexo/customers/refresh-expenditure/{id}', 'NexoCustomersController@refreshExpenditures' );
...
$Routes->get( 'nexo/items/reorder', 'NexoItemsController@reorder' );
...
$Routes->post( 'nexo/supplies/items/{shipping_id}/export_csv', 'NexoSuppliesController@delivery_items' );
$Routes->post( 'nexo/supplies/items/{shipping_id}/export', 'NexoSuppliesController@delivery_items' );
$Routes->get( 'nexo/supplies/items/{shipping_id}/delete/{id}', 'NexoSuppliesController@delivery_items' );
...
$Routes->get( 'nexo/providers_history/{provider_id}/{page?}', 'NexoProvidersController@history' );
...
$Routes->get( 'nexo/generate-barcode/{barcode}/{type?}', 'NexoItemsController@generate_barcode', ['defaultParameterRegex' => '[\w|.|-]+']);
...
$Routes->get( 'nexo/builder', function() {
    $order      =   ( new OrderReceiptBuilder( 63 ) )->get();
