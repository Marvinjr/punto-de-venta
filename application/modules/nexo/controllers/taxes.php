...
class NexoTaxesController extends Tendoo_Module
{
    ...
    public function crud_header()
    {
        ...
        $columns                =   [ 'NAME', 'RATE', 'AUTHOR', 'DATE_CREATION' ];

		$crud->columns( $this->events->apply_filters( 'nexo_taxes_crud_columns', $columns ) );
        $crud->fields( $this->events->apply_filters( 'nexo_taxes_crud_fields', $fields ) );
        ...
        $crud->unset_jquery();
        $crud       =   $this->events->apply_filters( 'nexo_taxes_crud_loaded', $crud );
        $output     =   $crud->render();
