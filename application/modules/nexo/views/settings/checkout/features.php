...
$this->Gui->add_item([
    'type'        =>    'select',
    'name'        =>    store_prefix() . 'nexo_show_net_price',
    'label'        =>    __('Utiliser les prix brut', 'nexo'),
    'description'        =>    __('Permet d\'afficher le prix brut de chaque article.', 'nexo'),
    'options'    =>    [
        ''            =>    __('Veuillez choisir une option', 'nexo'),
        'yes'        =>    __('Oui', 'nexo'),
        'no'        =>    __('Non', 'nexo')
...
$this->events->do_action( 'checkout_features_settings', $this->Gui, $namespace );