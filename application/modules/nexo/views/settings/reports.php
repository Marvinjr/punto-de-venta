...
$this->Gui->add_item([
    'type'  =>  'text',
    'name'  =>  store_prefix() . 'report_from_email',
    'label' =>  __( 'Email de l\'expéditeur', 'nexo' ),
    'description'   =>  __( "Permettra de déterminer l'adresse du service qui envoi le courrier.", 'nexo' )
], 'nexo_reports', 1 );
