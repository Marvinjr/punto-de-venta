...
if ( @$menu[ 'type' ] == 'dropdown' ) {
    ...
    <div class="dropdown" style="display:inline-block">
        ...
        <?php foreach( ( array ) @$menu[ 'options' ] as $option ):?>
            ...
            ?>
            <li>
                <a class="<?php echo @$option[ 'class' ];?>" href="<?php echo @$option[ 'url' ] ? $option[ 'url' ] : 'javascript:void(0)';?>" <?php echo $_attrs;?>>
                    <i class="fa fa-<?php echo @$option[ 'icon' ];?>"></i> <?php echo @$option[ 'text' ] ? $option[ 'text' ] : __( 'Sans Nom', 'nexo' );?>
                </a>
            </li>
        <?php endforeach;?>
        </ul>
