                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <div class="btn-group" data-toggle="btn-toggle">
                                    <button ng-click="prevWeek()" type="button" class="btn btn-default btn-sm active">
                                        <i class="fa fa-arrow-circle-left"></i>
                                    </button>
                                    <button ng-click="nextWeek()" ng-class="{ 'disabled': isNextDisabled }" type="button" class="btn btn-default btn-sm">
