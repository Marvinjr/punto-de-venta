<div class="row" ng-controller="stockSupplyingCTRL">
    ...
    <div class="col-md-12" ng-cloak ng-show="item.length == 1">
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" ng-show="shippings.length > 0" ng-class="{ 'has-error' : ( ( form.shipping.$error.required && form.$submitted ) || ( form.shipping.$touched && form.shipping.$error.required ) ) }">
                            ...
                            <div ng-if="shippings === null" class="callout callout-info">
                                <?php echo __( 'Chargement des approvisionnements en cours...', 'nexo' );?>
                            </div>
                            <div ng-if="shippings.length === 0" class="callout callout-info">
                                <?php echo __( 'Le produit n\'a pas encore été approvisionner son stock ne peut par conséquent pas être ajusté.', 'nexo' ) ;?>
                            </div>
            ...
            <div class="col-md-6">
                <div class="box" v-show="hasSelectedSupply">
                    <div class="box-header with-border">
