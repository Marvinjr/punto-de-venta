                ...
                **/
                ...
                if (in_array($meta_type = riake('type', $meta), array( 'box-default', 'box-primary', 'box-success', 'box-info', 'box-warning', 'box' ))) {
                    ...
                    if ( riake('gui_saver', $meta)) {
                        ?>
						<form ng-non-bindable class="form <?php echo $class;?>" id="<?php echo $id;?>" action="<?php echo $action;?>" enctype="<?php echo $enctype;?>" method="<?php echo $method;?>">
                        ...
                        ?>
                        <form ng-non-bindable class="form <?php echo $class;?>" id="<?php echo $id;?>" enctype="<?php echo $enctype;?>" method="<?php echo $method;?>">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                        <?php
                    }
                    ...
                    **/
                    ...
                    <?php
                    // enable gui form saver
                    if (riake('gui_saver', $meta) || in_array( $action, [ null, false ], true ) ) {
                        ?>
						</form>
						<?php
                    }
                    ...
                    // enable gui form saver
                    if (riake('gui_saver', $meta) || in_array($action, array( null, false ), true) ) {
                        ?>
						</form>
						<?php
                    }
