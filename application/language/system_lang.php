...
$lang[ 'assets-builded' ]               =   tendoo_info( __( 'The assets files has been builded' ) );
$lang[ 'assets-published' ]               =   tendoo_info( __( 'The assets files has been published' ) );
// Registration
...
$lang[ 'reset-not-handled' ]                =    tendoo_error(__('Resetting the setup is not handled by this module.'));
$lang[ 'reset-not-properly-handled' ]                =    tendoo_error(__('The module has\'nt returned a valid state after the operation.'));
$lang[ 'reset-completed' ]                =    tendoo_success(__('The reset process has runned successfully.'));
