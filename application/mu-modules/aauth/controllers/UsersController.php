...
class UsersController extends Tendoo_Module
{
    ...
    public function edit( $index )
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->events->do_action( 'after_user_updated', $index, $user );
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            if ($exec == 'user-created') {
                $user_id    =   $this->auth->get_user_id( $this->input->post( 'user_email' ) );
                $user       =   $this->auth->get_user( $user_id );
                
                $this->events->do_action( 'after_user_created', $user_id, $user );
